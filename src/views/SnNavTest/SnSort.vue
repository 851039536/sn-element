<template>
	<div class="SnNavigation">
		...
		<div class="SnNavigation-2">
          ...
          "
				 :border="true" size="small" :highlight-current-row="true" style="width: 100% ">
					...
					<el-table-column label="别名" prop="sortAlias">
					</el-table-column>
		...
		<!-- 分页 -->
		<el-pagination @current-change="current_change" :page="page" :page-size="pagesize" layout="prev, pager, next" :total="total"></el-pagination>
	</div>
</template>
...
<script>
	export default {
		...
		methods: {
			...
			GetPaging() {
				this.$api({
						url: "/api/SnSort/GetfyTest?pageIndex=" +
							this.page +
							"&pageSize=" +
							this.pagesize +
							"&isDesc=" +
