      ...
      <el-tabs type="border-card">
        <el-tab-pane label="文章管理">
          <div class="SnArticle-3">
            <div class="SnArticle-3-1" v-for="info in LabelsData" :key="info.pictureTypeId">
              <el-link
                :underline="false"
          ...
          <div class="SnArticle-2">
            <el-main>
              <el-table
                ...
                style="width: 100% "
              >
                <el-table-column label="pictureId" prop="pictureId"></el-table-column>
                <el-table-column label="pictureUrl" prop="pictureUrl"></el-table-column>
                <el-table-column label="pictureTitle" prop="pictureTitle"></el-table-column>
                <el-table-column label="pictureTypeId" prop="pictureTypeId"></el-table-column>
